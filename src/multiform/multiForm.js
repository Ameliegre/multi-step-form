        ...
        <MultiFormWrapper>
            <AnimatePresence initial={false} mode='wait'>
                ...
                <motion.div key="first" initial={{ y: 500, opacity: 0 }} animate={{y: 0, opacity: 1 }} transition={{duration: 0.5}} exit={{ y: -500, opacity: 0 }}>
                    <FirstPage setStep={setStep} step={step} formValues={formValues} setFormValues={setFormValues} />
                </motion.div>
                )}
                {step === 2 && (
                <motion.div key="second" initial={{ y: 500, opacity: 0 }} animate={{y: 0, opacity: 1 }} transition={{duration: 0.5}} exit={{ y: -500, opacity: 0 }}>
                    <SecondPage setStep={setStep} step={step} formValues={formValues} setFormValues={setFormValues} handlePrevious={handlePrevious} />
                </motion.div>
                )}
                {step === 3 && (
                <motion.div key="third" initial={{ y: 500, opacity: 0 }} animate={{y: 0, opacity: 1 }} transition={{duration: 0.5}} exit={{ y: -500, opacity: 0 }}>
                    <ThirdPage setStep={setStep} step={step} formValues={formValues} setFormValues={setFormValues} handlePrevious={handlePrevious} />
                </motion.div>
                )}
                {step === 4 && (
                <motion.div key="fourth" initial={{ y: 500, opacity: 0 }} animate={{y: 0, opacity: 1 }} transition={{duration: 0.5}} exit={{ y: -500, opacity: 0 }}>
                    <FourthPage setStep={setStep} step={step} formValues={formValues} handlePrevious={handlePrevious} />
                </motion.div>
                )}
                {step === 5 && (
